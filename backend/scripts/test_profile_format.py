"""
테스트Profile형식생성부합하는지OASIS요구사항
검증：
1. Twitter Profile생성CSV형식
2. Reddit Profile 생성 JSON 상세 형식  
"""
...
def test_profile_formats():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # 테스트Reddit JSON형식
        print("\n2. 테스트 Reddit Profile (JSON 상세 형식)")  
        print("-" * 40)
...
def show_expected_formats():
    """표시 OASIS 기대의 형식"""  
    print("\n" + "=" * 60)
    print("OASIS 기대의 Profile 형식 참고")  
    print("=" * 60)
    
    print("\n1. Twitter Profile (CSV형식)")
    print("-" * 40)
