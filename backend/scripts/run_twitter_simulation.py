...
사용 방식:
    ...
    python run_twitter_simulation.py --config /path/to/simulation_config.json --no-wait  # 완료즉시닫기
"""
...
class TwitterSimulationRunner:
    ...
    # Twitter 사용 가능한 액션（인터뷰 제외，인터뷰는 수동으로 ManualAction으로 트리거）
    AVAILABLE_ACTIONS = [
        ...
        if initial_posts:
            ...
            for post in initial_posts:
                ...
                try:
                    ...
                    print(f"  경고: Agent {agent_id}의 초기 게시물 생성 실패: {e}")
