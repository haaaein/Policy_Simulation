...
2. 시뮬레이션 스크립트가 명령 디렉토리를 폴링하여 명령 실행 후 responses/ 디렉토리에 응답 기록
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: 지정 플랫폼 (선택)
                ...
                - None: 듀얼 플랫폼 시뮬레이션 시 양쪽 동시 인터뷰, 단일 플랫폼 시 해당 플랫폼 인터뷰
            timeout: 타임아웃 시간
    ...
    def send_batch_interview(
        ...
        Args:
            interviews: 인터뷰 리스트, 각 요소는 {"agent_id": int, "prompt": str, "platform": str(선택)} 포함
            platform: 기본 플랫폼 (선택, 각 인터뷰 항목의 platform으로 재정의 가능)
                - "twitter": 기본적으로 Twitter 플랫폼만 인터뷰
                - "reddit": 기본적으로 Reddit 플랫폼만 인터뷰
                - None: 듀얼 플랫폼 시뮬레이션 시 각 Agent 양쪽 동시 인터뷰
            timeout: 타임아웃 시간
