  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">정책 파급효과 시뮬레이터</span>
            <span class="version-text">/ Evidence-Grounded Policy Simulation</span>
          </div>
          
          <h1 class="main-title">
            정책 문서를 업로드하면<br>
            <span class="gradient-text">파급효과를 시뮬레이션</span>
          </h1>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <h2 class="section-title">분석 준비 완료</h2>
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">과거 정책 성과 데이터로 예측 보정</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">다중 시나리오</div>
              <div class="metric-label">이해관계자별 에이전트 시뮬레이션</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">정책 문서에서 온톨로지 추출 & 이해관계자·예산·제약 관계 그래프 구축</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">이해관계자별 에이전트 페르소나 생성 & 시나리오 파라미터 설정</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">다중 시나리오 병렬 시뮬레이션 & 정책 파급 경로 탐색 & 그래프 실시간 업데이트</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Critic 모듈이 예측을 검증 & 근거 추적 가능한 파급효과 분석 보고서 생성</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">시나리오별 비교 & 반사실적 질의 & 이해관계자 에이전트와 직접 대화</div>
                </div>
              </div>
            </div>
          </div>
